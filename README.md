...
当我们想要找到520这个数字时，我们可以先找第（0+8）/2（取整）的位置的数字，就是第4位（从0开始数），即120，发现520比120大，那么往后找，即（5+7）/2的位置，即第6位，是521，以此类推，直到找到520为止。  
  
所以这里的话，我们知道每道题有11行，比如有88道题，那么我们先找88/2=44的位置的题，把鼠标光标放在这道题的最后一行上，看看行数，如果除以11，余数不是0的话，那么这道题前面有问题，是0的话，后面有问题，以此类推，直到找到为止。  
